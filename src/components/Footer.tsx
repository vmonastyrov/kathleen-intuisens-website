  ...
  return (
    <footer role="contentinfo" style={{ backgroundColor: 'var(--color-heading)', color: 'white', padding: '4rem 1.5rem 2rem' }}>
      <div className="container">
        <div className="columns">
          <div className="column is-5">
            ...
            <p style={{ color: '#D1D5DB', lineHeight: '2', fontSize: '1.05rem' }}>
              <strong style={{ color: 'white' }}>Telefon:</strong> +49 151 22 726 724<br />
              <span style={{ fontSize: '0.9rem', color: '#B0B5BC' }}>
            ...
            <p style={{ color: '#D1D5DB', lineHeight: '2', marginTop: '1rem', fontSize: '1.05rem' }}>
              <strong style={{ color: 'white' }}>E-Mail:</strong> <a href="mailto:navanita@live.de" style={{ color: 'var(--color-yellow-green)', textDecoration: 'none' }}>navanita@live.de</a><br />
        ...
        <div style={{ textAlign: 'center', color: '#B0B5BC', fontSize: '0.9rem' }}>
